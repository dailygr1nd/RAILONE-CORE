# RailOne Pilot Convergence - Step 09
...
```powershell
python .\step_09_mpesa_sandbox\run_tests.py
```

For an editable local installation, run this once inside the Step 09 directory:
...
there is no parent-level `tests` package. The runner resolves the Step 09 project
