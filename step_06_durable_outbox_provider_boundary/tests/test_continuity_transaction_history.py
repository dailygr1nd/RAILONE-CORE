    ...
    def _p2p_utt(self, *, request_id: str = "REQ-P2P-001") -> str:
        quote = QuoteService(self.signatures).issue_quote(
            terms=QuoteTerms(
                ...
                payer=ActorReference("PERSON", self.sender_uid, "PAYER-ACCOUNT"),
                beneficiary=ActorReference(
                    "PERSON", self.receiver_uid, "BENEFICIARY-ACCOUNT"
                ),
    ...
    def _merchant_utt(self) -> str:
        quote = QuoteService(self.signatures).issue_quote(
            terms=QuoteTerms(
                ...
                payer=ActorReference("MERCHANT", "MER002", "MERCHANT-ACCOUNT"),
                beneficiary=ActorReference("SUPPLIER", "SUP001", "SUPPLIER-ACCOUNT"),
