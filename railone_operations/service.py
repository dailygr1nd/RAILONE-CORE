...
from .endpoints import AccountEndpointResolver
...
class ProviderSubmissionCoordinator:
    ...
    def __init__(
        ...
        *,
        ...
        endpoint_resolver: AccountEndpointResolver,
    ...
    def prepare(
        ...
        payer_endpoint = utt["payer"]["endpoint"]
        beneficiary_endpoint = utt["beneficiary"]["endpoint"]
        payer_reference = self._endpoint_resolver.resolve(
            institution_id=payer_endpoint["institution_id"],
            account_binding_id=payer_endpoint["account_binding_id"],
        )
        beneficiary_reference = self._endpoint_resolver.resolve(
            institution_id=beneficiary_endpoint["institution_id"],
            account_binding_id=beneficiary_endpoint["account_binding_id"],
        )
        request_material = {
            ...
            "provider_id": provider_id,
            "adapter_binding_ref": route["adapter"],
            "rail": route["rail"],
            ...
            "source_institution_id": payer_endpoint["institution_id"],
            "destination_institution_id": beneficiary_endpoint["institution_id"],
            "payer_account_reference": payer_reference,
            "beneficiary_account_reference": beneficiary_reference,
        }
