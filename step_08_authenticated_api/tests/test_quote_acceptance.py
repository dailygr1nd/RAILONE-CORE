...
class QuoteAcceptanceTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.quotes = QuoteService(self.signatures)
        ...
        self.terms = QuoteTerms(
            request_id="REQ-001",
            payer=ActorReference("MERCHANT", "MER002", "EXT-PAYER-001"),
            beneficiary=ActorReference("SUPPLIER", "SUP-001", "EXT-BEN-001"),
    ...
    def test_p2p_is_a_first_class_accepted_origin(self) -> None:
        p2p_terms = QuoteTerms(
            ...
            payer=ActorReference("PERSON", "CUID-SENDER", "EXT-PAYER-P2P"),
            beneficiary=ActorReference(
                "PERSON", "CUID-RECEIVER", "EXT-BEN-P2P"
            ),
