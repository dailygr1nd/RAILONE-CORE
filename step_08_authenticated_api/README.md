# RailOne Pilot Convergence - Step 08
...
For an editable local installation, run this once inside the Step 08 directory:
...
Step 09 should add exactly one provider sandbox adapter and verified callback
inbox processing for the frozen pilot corridor.
